...
@allure.title("Test Page Buttons into simple button")
...
@allure.title("Test Page Buttons into looks like button")
...
@allure.title("Test Page Buttons into Disabled button")
